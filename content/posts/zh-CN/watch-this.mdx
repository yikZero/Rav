...
titleEn: 'Create Your Personal Movie List with AI'
publishedAt: 2024-11-23
description: '本文介绍如何借助 AI 强大的数据分析能力，整合多个影视榜单，为你总结生成一份每周热门观影清单'
descriptionEn: 'This article introduces how to use AI's powerful data analysis capabilities to integrate multiple movie and TV lists and generate a weekly list of popular movies for you'
