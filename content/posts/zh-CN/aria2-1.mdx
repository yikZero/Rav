...
titleEn: 'Aria2: Email Notifications for Downloads'
publishedAt: 2020-02-09
description: '使用 Aria2 下载完成后，通过 sendmail 和自定义脚本自动发送邮件通知'
descriptionEn: 'Automatically send email notifications via sendmail and custom scripts after download completion using Aria2'
