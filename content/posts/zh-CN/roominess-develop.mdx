---
title: '从产品设计师角度，聊聊博客搭建方法'
titleEn: 'Building a Blog: A Product Designer's Guide'
publishedAt: 2024-09-21
description: '网站也已经改版一段时间了，内容模块也相对完善。所以这次，从设计到开发，我也想讲讲自己的经验'
descriptionEn: 'The website has also been revamped for a while, and the content modules are relatively complete. So this time, from design to development, I would also like to talk about my own experience'
