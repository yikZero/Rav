  ...
  return (
    <section className="mx-auto flex w-full flex-col items-center gap-12 px-4 pt-32 sm:px-6 sm:pt-40">
      <div className="hero-animate group relative rotate-2 will-change-transform hover:rotate-3">
        ...
        />
        <div className="absolute top-1 -z-1 size-12 rounded-xl opacity-0 blur-xs transition duration-300 group-hover:bg-[url(https://cdn.yikzero.com/common/avatar.jpg)] group-hover:opacity-30" />
      </div>
