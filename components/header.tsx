...
export default function Header() {
  return (
    <div className="fixed inset-x-0 top-10 z-50">
      <header className="mx-auto flex w-fit flex-row gap-1 rounded-xl bg-linear-to-b from-[#172554]/15 to-[#172554]/9 p-1 text-sm font-normal shadow-[#01040E]/8 outline outline-white/6 backdrop-blur-[2px] transition duration-300 hover:outline-white/9">
        <Link
          href="/"
